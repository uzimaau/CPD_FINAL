...
android {
    namespace = "com.example.cpd_final"
    ...
    defaultConfig {
        ...
        applicationId = "com.example.cpd_final"
...
dependencies {
  ...
  implementation("com.google.firebase:firebase-firestore")  // For Firebase Firestore (if needed)
